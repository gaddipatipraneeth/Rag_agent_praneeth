...
class Settings(BaseSettings):
    ...
    groq_api_key: str = Field(default="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", alias="GROQ_API_KEY")
...
class LLMFactory:
    ...
    def _create_groq(self) -> BaseChatModel:
        ...
        if not self._settings.groq_api_key:
            raise EnvironmentError("GROQ_API_KEY environment variable is required for Groq provider")
        return ChatGroq(
