...
class DocumentChunker:
    ...
    def chunk_file(
        ...
        for raw_chunk in raw_chunks:
            text = raw_chunk['text']
            chunk_metadata = replace(metadata)
            if 'page' in raw_chunk:
                chunk_metadata.page = raw_chunk['page']
            chunk_id = VectorStoreManager.generate_chunk_id(chunk_metadata.source, text)
